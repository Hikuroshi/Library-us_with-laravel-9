            ...
            <div class="card-body">
                <form action="/dashboard/books" method="POST" class="m-t-40" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="writer" class="form-control @error('writer') is-invalid @enderror" value="{{ old('writer') }}" required autofocus data-validation-required-message="This field is required">
                        @error('writer')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
